...
$img_width = $board['bo_gallery_width'];
$img_height = $board['bo_gallery_height'];

// add_stylesheet('css 구문', 출력순서); 숫자가 작을 수록 먼저 출력됨
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/css/default.css">', 0);
	...
	<div class="container">
		<div class="box">
				...
				<div class="port-2 effect-3">
					<div class="image-box">
						<img src="<?=$img_content?>" alt="<?php echo $list[$i]['subject']?>">
					</div>
					<div class="text-desc">
					<a href="<?php echo $list[$i]['href'];?>">
						<h3><?php echo mb_strimwidth($list[$i]['subject'], '0', '15', '', 'utf-8');?></h3>
						<p><?php echo mb_strimwidth($list[$i]['wr_content'], '0', '85', '', 'utf-8');?></p></a>
